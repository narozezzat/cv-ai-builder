 ...
 * Database types.
 *
 * Regenerate with `pnpm gen:types` (requires a running local Supabase). This
 * file is written in the exact shape `supabase gen types typescript` emits, so
 * regeneration overwrites it wholesale and any drift between the migrations and
 * the types shows up as a diff. It is excluded from ESLint and Prettier for the
 * same reason.
 *
 * Two deliberate departures from the generator, both because the generator maps
 * types it does not model to `unknown` and `unknown` is useless at a call site:
 * `activity_logs.ip_address` (inet) is typed `string`, and
 * `check_rate_limit.p_window` (interval) is typed `string`. PostgREST transports
 * both as strings.
 */
    ...
    Tables: {
      ...
      resume_custom_entries: {
        ...
        Relationships: [
          ...
          {
            foreignKeyName: "resume_custom_entries_user_id_fkey";
            columns: ["user_id"];
            isOneToOne: false;
            referencedRelation: "users";
            referencedSchema: "auth";
      ...
      resume_references: {
        ...
        Relationships: [
          ...
          {
            foreignKeyName: "resume_references_user_id_fkey";
            columns: ["user_id"];
            isOneToOne: false;
            referencedRelation: "users";
            referencedSchema: "auth";
      ...
      resume_sections: {
        ...
        Relationships: [
          ...
          {
            foreignKeyName: "resume_sections_user_id_fkey";
            columns: ["user_id"];
            isOneToOne: false;
            referencedRelation: "users";
            referencedSchema: "auth";
